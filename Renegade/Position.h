...
public:
    ...
    inline uint64_t GetMinorKey() const {
        return MurmurHash3(WhiteBishopBits() | WhiteKnightBits() | WhiteKingBits()) ^
            MurmurHash3((BlackBishopBits() | BlackKnightBits() | BlackKingBits()) ^ Zobrist[780]);
    }
