...
public:
    ...
    void UpdateCorrection(const Position& position, const int16_t staticEval, const int16_t score, const int depth, const bool exactNode);
...
private:
    ...
    static constexpr int CorrectionCap = 64;
